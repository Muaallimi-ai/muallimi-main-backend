"""Local email notification stub for Phase 4.

Accepts POST /dispatch with a JSON body and writes a delivery receipt to
/receipts/email/. Does not actually send email; just records what would have
been sent so tests can assert on-disk evidence.
"""
